...
Revision ID: feda1fd5784c
Revises: c40674f97ccc
Create Date: 2026-01-17 21:13:51.004814
...
revision: str = 'feda1fd5784c'
down_revision: Union[str, None] = 'c40674f97ccc'
...
def upgrade() -> None:
    ...
    op.drop_column('fee', 'created_at')
    op.drop_column('fee', 'updated_at')
    ...
    op.create_foreign_key(None, 'student_exam_fee', 'students', ['student_id'], ['id'])
    op.create_foreign_key(None, 'student_exam_fee', 'exam_fees', ['exam_fee_id'], ['id'])
    op.drop_column('student_exam_fee', 'created_at')
    op.drop_column('student_exam_fee', 'updated_at')
    ...
    op.create_foreign_key(None, 'student_fee', 'students', ['student_id'], ['id'])
    op.create_foreign_key(None, 'student_fee', 'fee', ['fee_id'], ['id'])
    op.drop_column('student_fee', 'created_at')
    op.drop_column('student_fee', 'updated_at')
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('student_fee', sa.Column('updated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True))
    op.add_column('student_fee', sa.Column('created_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True))
    op.drop_constraint(None, 'student_fee', type_='foreignkey')
    op.drop_constraint(None, 'student_fee', type_='foreignkey')
    op.drop_index(op.f('ix_student_fee_id'), table_name='student_fee')
    op.create_index('ix_student_fee_student_id', 'student_fee', ['student_id'], unique=False)
    op.create_index('ix_student_fee_fee_id', 'student_fee', ['fee_id'], unique=False)
    op.add_column('student_exam_fee', sa.Column('updated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True))
    op.add_column('student_exam_fee', sa.Column('created_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True))
    op.drop_constraint(None, 'student_exam_fee', type_='foreignkey')
    op.drop_constraint(None, 'student_exam_fee', type_='foreignkey')
    op.drop_index(op.f('ix_student_exam_fee_id'), table_name='student_exam_fee')
    op.create_index('ix_student_exam_fee_student_id', 'student_exam_fee', ['student_id'], unique=False)
    op.create_index('ix_student_exam_fee_exam_fee_id', 'student_exam_fee', ['exam_fee_id'], unique=False)
    op.add_column('fee', sa.Column('updated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True))
    op.add_column('fee', sa.Column('created_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True))
